import sys
sys.append_path(~/PICASSO/picasso)
import nn_picasso
...
mixed = imageio.imread('/Users/kpandit/PICASSO/sample_data/mouse_spinalcord_small.tiff')
...
picasso = nn_picasso.PICASSOnn(mixing_matrix)
train_info = picasso.train_loop(mixed, batch_size = 10000, max_iter=100)
unmixed = picasso.unmix(mixed)

imageio.imwrite('unmixed.tiff', unmixed)
